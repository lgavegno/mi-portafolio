  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <motion.div
          className="bg-slate-800/30 rounded-xl px-8 py-12 text-center"
        ...
        >
          ...
          <motion.p
            className="font-dm-sans text-slate-300 text-base leading-relaxed mb-8"
            variants={fadeInUp}
          >
            {s.cuerpo}
          </motion.p>
          ...
          <motion.div variants={fadeInUp}>
            <a
              href={MAILTO_URL}
              onClick={handleClick}
              className="inline-flex items-center justify-center gap-2 bg-sky-500 hover:bg-sky-400 text-white font-syne font-semibold px-8 py-3 rounded-lg transition-colors"
            >
              <FiMail size={18} />
              {s.ctaPrimario}
            </a>
